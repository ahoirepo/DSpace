...
<%@ page import="org.dspace.core.LicenseManager" %>
...
<%
    ...
    if (langcode.equals("en")) {
        fname = "/srv/dspace/dspace/config/default_en.license";
    }
    else {
        fname = "/srv/dspace/dspace/config/default.license";
    }

    String license = LicenseManager.getLicenseText(fname);

//    String license = (String) request.getAttribute("license");
    String licensetext = license.replaceAll("\n","<br/>");
%>
...
<dspace:layout style="submission"
	...
	<div class="alert alert-info"><fmt:message key="jsp.submit.show-license.info1"/></div>
        ...
        <%-- <pre class="panel panel-primary col-md-10 col-md-offset-1"><%= fname %></pre> --%>
        <div style="border: black solid 1px; background: yellow; padding: 5px;"><%= licensetext %></div>
