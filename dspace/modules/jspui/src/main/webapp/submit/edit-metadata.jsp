      ...
      throws java.io.IOException
    {
      ...
      for (int i = 0; i < fieldCount; i++)
      {
         ...
         if (repeatable && !readonly && i < defaults.length)
         {
            ...
            sb.append("<button class=\"btn btn-danger col-md-2\" style=\"margin-left:15px;\" name=\"submit_")
              .append(fieldName)
              .append("_remove_")
              .append(i)
              .append("\" value=\"")
         ...
         else if (repeatable && !readonly && i == fieldCount - 1)
         {
            ...
            sb.append("<button class=\"btn btn-default col-md-2\" style=\"margin-left:15px;\" name=\"submit_")
              .append(fieldName)
              .append("_add\" value=\"")
...
//          .append(">(No month)</option>");
         ...
         sb.append("\" size=\"2\" maxlength=\"2\" value=\"")
            .append((dateIssued.getDay() > 0 ?
                ...
                .append("\"/></span><span class=\"input-group\"><span class=\"input-group-addon\">")
...
//            .append("_add\" value=\"Add More\"/> </td></tr>");
      ...
      throws java.io.IOException
    {
     Metadatum[] defaults = item.getMetadata(schema, element, qualifier, Item.ANY);
      ...
      sb.append("<span class=\"col-md-8\" style=\"padding-left:30px;\">")
...
<%
     ...
     {
%>
        <p><fmt:message key="jsp.submit.edit-metadata.info3"/></p>
