...
%>
       ...
       <nav class="collapse navbar-collapse bs-navbar-collapse" role="navigation">
         <ul class="nav navbar-nav">
          ...
          <!-- TUBHH Menu -->
          <li class="dropdown">
             <a href="#" class="dropdown-toggle" data-toggle="dropdown"><fmt:message key="jsp.layout.navbar-default.tubdok-menu"/>  <b class="caret"></b></a>
             <ul class="dropdown-menu">
                <li><a href="<%= request.getContextPath() %>/staticpages.jsp?incFile=2"><fmt:message key="jsp.layout.navbar-default.tubdok-contact"/></a></li>
                <li class="divider"></li>
...
<%--                <li><a href="<%= request.getContextPath() %>/staticpages.jsp?incFile=7"><fmt:message key="jsp.layout.navbar-default.tubdok-dissnote"/></a></li>        --%>
                <li><a href="<%= request.getContextPath() %>/staticpages.jsp?incFile=10"><fmt:message key="jsp.layout.navbar-default.tubdok-publnote"/></a></li>
                <li class="divider"></li>
<%--                <li><a href="<%= request.getContextPath() %>/staticpages.jsp?incFile=3"><fmt:message key="jsp.layout.navbar-default.tubdok-documentation"/></a></li>         --%>
	...
	<form method="get" action="https://katalog.tub.tu-harburg.de/Search/Results/" class="navbar-form navbar-right" scope="search" accept-charset="UTF-8" target="_blank">
