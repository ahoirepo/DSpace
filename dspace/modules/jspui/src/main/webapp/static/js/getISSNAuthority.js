...
if (document.getElementsByName("page").length > 0) {
    ...
    var journal = document.getElementById("tuhh_relation_ispartof");
    var issn = document.getElementById( "dc_identifier_issn" );
    var seriesSelect = document.getElementsByName("tuhh_series_id")[0];
...
function input_series() {
    series.value = seriesSelect.options[ seriesSelect.selectedIndex ].text;
}
